...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_dir', type=str, default='/data2/datasets/drivelm/output3/241103_gp_icl/checkpoint-1737', help='Directory of model weights')
    parser.add_argument('--json_path', type=str, default='/data2/datasets/drivelm/similarity_rank/bert/for_ft/test_vt_gp_top_1_img.jsonl', help='Path to the input JSON file')
    parser.add_argument('--out_json_path', type=str, default='/data2/datasets/drivelm/241104/test_vt_gp_1_img_ft_3_prompt.jsonl', help='Path to the output JSON file')
