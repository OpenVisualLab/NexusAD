...
def extract_data(root_path, save_path):
    ...
    for scene_id in tqdm(train_file.keys(), desc="Extracting"):
...
if __name__ == "__main__":
    ...
    # root_path = os.path.join(data_root, "data/train_sample.json")
    # save_path = os.path.join(data_root, "test.json")
    # extract_data(root_path, save_path)
    
    # 创建 ArgumentParser 对象
    parser = argparse.ArgumentParser(description="Extract data from JSON files")
