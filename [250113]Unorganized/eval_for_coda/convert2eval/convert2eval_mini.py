...
if __name__ == "__main__":
    ...
    parser.add_argument("--reference_path", type=str, default="/data1/nemo/projects/datasets/CODA/CODA-LM/Mini")
    parser.add_argument("--prediction_path", type=str, default="/data1/nemo/projects/240922_AD/output/out_jsons/240922/orignal/v0_ft10_rp.jsonl")
