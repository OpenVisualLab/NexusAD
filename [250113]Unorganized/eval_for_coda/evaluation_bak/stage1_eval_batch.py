...
if __name__ == "__main__":
    ...
    parser.add_argument("--reference_path", type=str, default="/data2/datasets/drivelm/data/coda/CODA-LM/Test")
    parser.add_argument("--prediction_path", type=str, default="/data2/datasets/drivelm/output2/nexusad/241024_ori_vl_8b/ori_qwen2_test_general_perception.jsonl")
    parser.add_argument("--save_path", type=str, default="/data2/datasets/drivelm/output2/nexusad/241024_ori_vl_8b/ori_qwen2_test_general_perception_2")
    ...
    parser.add_argument("--api_base_url", type=str, default='https://api.bianxie.ai/v1')
    # parser.add_argument("--api_base_url", type=str, default='http://localhost:8080/v1')
    ...
    for idx, json_name in tqdm(enumerate(json_list)):
        ...
        # message["prediction"] = answers[idx]['response']
        message["prediction"] = answers[idx]['prediction']
