...
if __name__ == "__main__":
    ...
    parser.add_argument("--prediction_path", type=str, default="/data1/nemo/projects/240922_AD/output/out_jsons/241023/struct_v0_ft10_local_ds2.jsonl")
    parser.add_argument("--save_path", type=str, default="/data1/nemo/projects/240922_AD/output/out_jsons/241023/struct_v0_ft10_local_ds2_true")
    ...
    parser.add_argument("--retry_attempts", type=int, default=1) # 10
