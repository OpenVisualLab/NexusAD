...
if __name__ == "__main__":
    ...
    parser.add_argument("--prediction_path", type=str, default="/data1/nemo/projects/240922_AD/output/out_jsons/240924/ori/v0_ft10_local_rp_w_label.jsonl")
    parser.add_argument("--save_path", type=str, default="/data1/nemo/projects/240922_AD/output/out_jsons/240922/orignal/v0_ft10_rp")
