...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/original/original_train_region_perception.jsonl" "/data2/datasets/drivelm/data/qas/original/original_val_region_perception.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/original/original_test_region_perception.jsonl" \
    --output_dir "/data2/datasets/drivelm/output2/internvl2-8b/original_test_rp_ft_4" \
