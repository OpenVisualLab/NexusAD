...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/structure/structure_train_general_perception.jsonl" "/data2/datasets/drivelm/data/qas/structure/structure_val_general_perception.jsonl" \
