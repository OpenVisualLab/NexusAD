...
# 执行swift命令
swift sft \
    --model_id_or_path "/data1/nemo/projects/pre_weights/Qwen2-VL-7B-Instruct" \
    --system "You are a seasoned driver, skilled at handling corner cases." \
    --dataset "/data2/datasets/drivelm/data/qas/new/new_train_driving_suggestion.jsonl" "/data2/datasets/drivelm/data/qas/new/new_val_driving_suggestion.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/new/new_test_driving_suggestion.jsonl" \
    --output_dir "/data2/datasets/drivelm/output3/241028_ds_qwen" \
