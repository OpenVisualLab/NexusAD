...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/new/new_train_region_perception.jsonl" "/data2/datasets/drivelm/data/qas/new/new_val_region_perception.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/new/new_test_region_perception.jsonl" \
    --output_dir "/data2/datasets/drivelm/output3/241028_rp_qwen" \
