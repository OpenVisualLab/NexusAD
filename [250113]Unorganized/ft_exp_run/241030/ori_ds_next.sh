...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/original/original_train_driving_suggestion.jsonl" "/data2/datasets/drivelm/data/qas/original/original_val_driving_suggestion.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/original/original_val_driving_suggestion.jsonl" \
    --output_dir "/data2/datasets/drivelm/output3/241030_ds_ori_next" \
