...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/original/original_train_region_perception.jsonl" "/data2/datasets/drivelm/data/qas/original/original_train_region_perception.jsonl" \
    ...
    --output_dir "/data2/datasets/drivelm/output3/241030_rp_ori_next" \
