...
swift sft \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/original/original_mini_general_perception.jsonl" \
    --output_dir "/data2/datasets/drivelm/output3/241103_gp_ori_next" \
