...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/similarity_rank/bert/for_ft/train_v_gp_top_1_img.jsonl" "/data2/datasets/drivelm/similarity_rank/bert/for_ft/val_t_gp_top_1_img.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/similarity_rank/bert/for_ft/test_vt_gp_top_1_img.jsonl" \
    --output_dir "/data2/datasets/drivelm/output3/241103_gp_icl" \
