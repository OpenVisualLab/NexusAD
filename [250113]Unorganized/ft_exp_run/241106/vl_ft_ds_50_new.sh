...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/new/new_train_driving_suggestion.jsonl" \
    ...
    --output_dir "/data2/datasets/drivelm/output3/new_241106_str_vl_test_ds_50_ft" \
