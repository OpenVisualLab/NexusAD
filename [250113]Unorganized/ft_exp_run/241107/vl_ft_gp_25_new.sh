...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/new/new_train_general_perception.jsonl"#2317 \
    ...
    --output_dir "/data2/datasets/drivelm/output3/new_241106_str_vl_test_gp_50_ft" \
