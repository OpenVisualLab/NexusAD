...
swift sft \
    ...
    --dataset "/data2/datasets/drivelm/data/qas/icl/icl_train_region_perception.jsonl" "/data2/datasets/drivelm/data/qas/icl/icl_val_region_perception.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/icl/icl_mini_region_perception.jsonl" \
    --output_dir "/data2/datasets/drivelm/output4/1108_rp_icl_ft" \
