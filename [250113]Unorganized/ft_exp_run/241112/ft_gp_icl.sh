...
swift sft \
    ...
    --resume_from_checkpoint "/data2/datasets/drivelm/output4/1112_gp_icl_ift/checkpoint-1158" \
    --model_type "internvl2-8b" \
    --system "You are a seasoned driver, skilled at handling corner cases." \
    --dataset "/data2/datasets/drivelm/similarity_rank/241110_rank_for_ft2/train_v_gp_v1_2.jsonl" "/data2/datasets/drivelm/similarity_rank/241110_rank_for_ft2/val_t_gp_v1_2.jsonl" \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/qas/new/new_mini_general_perception.jsonl" \
    --output_dir "/data2/datasets/drivelm/output4/1112_gp_icl_ift" \
