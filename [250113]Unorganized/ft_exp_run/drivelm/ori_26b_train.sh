...
swift sft \
    ...
    --save_total_limit -1 \
    --use_flash_attn True \
    --val_dataset "/data2/datasets/drivelm/data/drivelm-nuscenes/demo_test_swift.jsonl" \
    --output_dir "/data2/datasets/drivelm/output" \
    --device_map_config "/data1/nemo/projects/spatial_ad/a_pin_jsons/device_maps/vl_26b_2.json" \
