...
def main(data_root, model_dir, ckpt_dir, json_path, out_json_path, batch_size=1, tqdm_position=0): #TODO
    ...
    with open(out_json_path, 'a') as outf, tqdm(total=total_samples, position=tqdm_position, leave=True, desc='Sample Progress') as pbar:
        for batch in batched_lines:
            ...
            responses = [run_vl2_model(model, template, questions[0], full_image_paths[0], histories[0])]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', type=str, default='/data2/datasets/drivelm/data/coda', help='Root directory of datasets')
    parser.add_argument('--batch_size', type=int, default=1, help='Batch size')
    parser.add_argument('--model_dir', type=str, default='/data1/nemo/projects/pre_weights/InternVL2-8B', help='Directory of model weights')
    parser.add_argument('--ckpt_dir', type=str, default='/data2/datasets/drivelm/output4/1112_gp_icl_ift/checkpoint-2316', help='Directory of model weights')
    parser.add_argument('--json_path', type=str, default='/data2/datasets/drivelm/similarity_rank/241110_rank_for_ft2/test_vt_gp_v1_3.jsonl', help='Path to the input JSON file')
    parser.add_argument('--out_json_path', type=str, default='/data2/datasets/drivelm/241113_icl_swift/test_icl_gp_v1_3_ft_4_his_3.jsonl', help='Path to the output JSON file')
